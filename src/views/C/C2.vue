    ...
    <div class="row justify-content-center">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <div class="row py-3">
              <div class="col-xxl-6 me-3 d-flex align-items-center">
                  <h5 class="text-nowrap me-3" style="padding-top:0.375rem;">請選擇查詢條件:</h5>
                  <select class="form-select me-3" v-model="searchForm.type">
                    <option selected value="">全部資料</option>
                    <option value="storeId">商店代號</option>
                    <option value="storeName">商店名稱</option>
                  </select>
                  <input type="text" class="form-control me-3" v-model.trim="searchForm.data">
                  <button class="btn btn-primary col-xxl-1 me-3" @click="getDataByCond(searchForm)">搜尋</button>
              </div>
            </div>
