      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            ...
            <h6 class="text-danger fw-bold">*檔名為: 商店代碼(自動依特店代碼欄位之值檢查)  + "." + YYYYMMDD(自動帶出今日日期) + "." + A(第一次上傳為A，第二次為B，以此類推)。</h6>
            <h6 class="text-danger fw-bold">*上傳檔案均需依約定之密碼規則(兩碼當月月份 + 約定之加解密密碼)，以zip加密。</h6>
          </div>
          <div class="card-body">
            <Form
              v-slot="{ errors }"
