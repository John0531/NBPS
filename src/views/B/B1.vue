      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            ...
            <h6>供<span class="text-primary">特店端</span>上傳批次交易資料檔，上傳功能僅於營業日之作業時間開放(例：營業日 <span class="text-primary">{{this.transTime}}</span>)，批次交易資料檔上傳且格式檢核成功後，按下確認並送出，系統隨開始發動交易。</h6>
