        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
              ...
              <div class="col-xxl-4 me-3 d-flex align-items-center">
                ...
                <input v-model="detailDataPost.pan" type="text" class="form-contorl me-3" style="padding-top:0.375rem;">
                <button @click="getDetail()" class="btn btn-primary me-3"> 查詢</button>
            </div>
