...
export default {
  ...
  methods: {
    ...
    async getError (itemData) {
      ...
      const res = await this.axios.get(url)
      this.$store.commit('changeLoading', false)
      this.errorData.fileName = itemData[2].data
      this.errorData.shopName = itemData[1].data
