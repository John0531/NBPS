...
const initFile = '150100147.txt'
oriFile = initFile

// 65 = A , 90 = Z
for (let i = 65; i <= 67; i++) {

inputFile = '150100147.'+`${year}${month}${day}.` + String.fromCharCode(i) + '.txt'
...
oriFile = inputFile
zipFilePath = '150100147.'+`${year}${month}${day}.` + String.fromCharCode(i) + '.zip'
