...
const initFile = '030103360.txt'
oriFile = initFile

// 65 = A , 90 = Z
for (let i = 65; i <= 67; i++) {

inputFile = '030103360.'+`${year}${month}${day}.` + String.fromCharCode(i) + '.txt'
...
oriFile = inputFile
zipFilePath = '030103360.'+`${year}${month}${day}.` + String.fromCharCode(i) + '.zip'
